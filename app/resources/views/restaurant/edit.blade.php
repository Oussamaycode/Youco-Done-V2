...
<input class="form-input w-full rounded-lg border-[#dce5e5] dark:bg-[#112121] dark:border-[#2a3f3f] h-12 px-4" placeholder="e.g. The Golden Spoon" type="text"/>
</label>
</div>
...
<input class="form-input w-full rounded-lg border-[#dce5e5] dark:bg-[#112121] dark:border-[#2a3f3f] h-12 px-4" placeholder="123 Culinary Ave" type="text"/>
</label>
</div>
<div class="col-span-1">
<label class="flex flex-col gap-2">
<span class="text-sm font-medium">City</span>
<input class="form-input w-full rounded-lg border-[#dce5e5] dark:bg-[#112121] dark:border-[#2a3f3f] h-12 px-4" placeholder="San Francisco" type="text"/>
</label>
</div>
<div class="col-span-1">
<label class="flex flex-col gap-2">
<span class="text-sm font-medium">Zip Code</span>
<input class="form-input w-full rounded-lg border-[#dce5e5] dark:bg-[#112121] dark:border-[#2a3f3f] h-12 px-4" placeholder="94103" type="text"/>
</label>
</div>
</div>
...
<input class="w-16 h-8 rounded border-[#dce5e5] dark:bg-[#112121] text-sm" type="number" value="45"/>
</label>
</div>
</div>
<div class="p-6">
...
<button class="px-8 py-2.5 rounded-lg bg-primary text-[#111818] text-sm font-bold shadow-lg shadow-primary/20">Next Section: Menu</button>
</div>
</div>
</footer>
</div>
